...
import { Bell, User, Moon, Sun, Sparkles, X } from 'lucide-react';
        ...
        <div className="h-16 bg-white dark:bg-gray-950">
            <div className="flex items-center justify-end h-full px-4">
                ...
                <div className="flex items-center gap-4">
                    {showPromo && (
                        <div className="flex-1 flex items-center justify-center underline">
                            <Link href='/refer' className="flex items-center gap-2 px-4 py-1.5 text-xs font-medium text-primary">
                                <Sparkles className="h-4 w-4" />
                                <span>Invite a friend and enjoy one month of premium for free!</span>
                                <Button
                                    variant="ghost"
                                    size="icon"
