...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-gray-100">
      ...
      <div className="w-full max-w-6xl h-4/5 flex bg-white shadow-lg rounded-lg">
        {/* Left Side */}
        <div className="w-1/2 p-10 overflow-y-auto hide-scrollbar">
            ...
            {isSignup && (
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button type="button" variant="outline" className="mt-1" onClick={handleSendOTP}>
                    Verify
                  </Button>
                </div>
              </div>
